...
KANBAN_GUIDANCE = (
    ...
    "eyes on it. **After a successful `kanban_complete`, STOP immediately** — "
    "emit your final summary and make NO further tool calls (never re-call "
    "`kanban_complete`; a second call just fails 'already terminal').\n"
